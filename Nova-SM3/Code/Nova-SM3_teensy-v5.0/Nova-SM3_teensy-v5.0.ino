...
//DEVWORK:  I'm confused... why does this seem to work with accel data, as opposed to the gyro data? 
//          mixed up registers in library perhaps?  Gyro data creates immediate "drift" back to zero, after responding
//          to accellerating the mpu, sooo....  very odd. And accel x / y are reversed gyro / orientation, as well.
//          For now, we'll use so-called "accel" data, but swap x and y
...
//    Serial.print("mpu x / y / z:\t\t"); Serial.print(mroll); Serial.print(" / "); Serial.print(mpitch); Serial.print(" / "); Serial.println(myaw);
    Serial.print("mpu ax / ay / az:\t\t"); Serial.print(ax); Serial.print(" / "); Serial.print(ay); Serial.print(" / "); Serial.println(az);
    Serial.println();
...
void battery_check() {
  ...
  batt_voltage = sensorValue * (3.3 / 1023.00) * 5.67; // Convert the reading values from 3.3v to 12V (4.7k/1k divider)
  if (debug4) {
